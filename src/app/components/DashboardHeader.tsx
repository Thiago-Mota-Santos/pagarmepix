              ...
              <MenubarTrigger className='py-1 transition-all'>
                <Flex>
                  <Avatar
                    ...
                    src={user.photoURL || ""}
                  />
                  <Flex align="start" direction="column" className='ml-1 hidden md:flex'>
                    <Text size="2" className="hidden md:flex">{user.displayName}</Text>
                ...
                <MenubarContent sideOffset={5} className="bg-white min-w-[120px] p-1.5 border shadow-custom rounded-lg border-gray-200">
